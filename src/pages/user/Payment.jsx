...
const Payment = () => {
  ...
  useEffect(() => {
    // Redirect if no policy selected or customer details missing
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="border rounded-md p-4">
              ...
              <p className="text-gray-600 mb-4 text-sm">
                This is a placeholder for Razorpay integration. In the actual implementation, 
                the Razorpay payment form would appear here.
              </p>
